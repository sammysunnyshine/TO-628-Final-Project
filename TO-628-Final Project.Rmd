...
Our goal is to build a model to predict which songs will be successful on Spotify, which serves as a proxy for the overall music market.

This will be extremely useful to artists, managers, producers, and all other parties who have stakes in launching new music. This data set provides a blueprint on how to create a successful song, regardless of genre, and can be used to evaluate existing songs or to write new ones.

*Our model will be able to determine with a high level of confidence whether a song will be a "hit" or a "flop."* Investment should be made in the former and not in the latter.
