...
```{r}
set.seed(12345)
test_set_comb <- sample(1:nrow(pred_comb_uk), 0.25*nrow(pred_comb_uk))
...
The stacked model is extremely strong and has a **Kappa of almost 71%**, greater than each individual model.
